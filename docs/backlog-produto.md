...
| Sprint 2 | Alocação das **onze** histórias no milestone [`Sprint 2`](https://github.com/gigi-zacaroni/tp-eng-software/milestone/1), com prioridade, responsável e label aplicados em cada Issue. Estado padronizado como `Especificada`. | O objetivo da sprint foi especificar e validar o escopo completo, não implementá-lo; todas as histórias passaram pelo mesmo ciclo de refinamento e validação no protótipo. | [milestone `Sprint 2`](https://github.com/gigi-zacaroni/tp-eng-software/milestone/1) |
