...
| Sprint 2 | `RF-01` a `RF-27` | Vínculo de todos os requisitos às onze Issues ([#2](https://github.com/gigi-zacaroni/tp-eng-software/issues/2), [#3](https://github.com/gigi-zacaroni/tp-eng-software/issues/3), [#5](https://github.com/gigi-zacaroni/tp-eng-software/issues/5)–[#13](https://github.com/gigi-zacaroni/tp-eng-software/issues/13)), todas alocadas ao milestone [`Sprint 2`](https://github.com/gigi-zacaroni/tp-eng-software/milestone/1) com prioridade e responsável. | Fechar a rastreabilidade requisito → história → Issue exigida pela disciplina. | [milestone `Sprint 2`](https://github.com/gigi-zacaroni/tp-eng-software/milestone/1) · [`rastreabilidade.md`](../rastreabilidade.md) |
