...
> As demais histórias (`US-02`, `US-04` a `US-11`) já estão registradas como Issues, mas não foram alocadas nesta sprint; sua rastreabilidade será registrada na sprint em que forem desenvolvidas.
